            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white py-3">
                        <h6 class="mb-0 fw-semibold">Informasi Purchase Order</h6>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-4">
...
@section('scripts')
    <script>
        ...
        function addRow() {
            ...
            tr.innerHTML = `
            <td>
                <select name="details[${idx}][product_id]" class="form-select form-select-sm product-select" required onchange="fillPrice(this, ${idx})">
                    <option value="">-- Pilih Produk --</option>
                    ${productOptions()}
                </select>
            </td>
