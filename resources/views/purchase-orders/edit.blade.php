        ...
        <div class="space-y-4">
            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                <div class="px-5 py-4 border-b border-gray-100">
                    <h6 class="font-semibold text-gray-700">Informasi Purchase Order — <span
                            class="text-gray-400 font-normal">{{ $purchaseOrder->po_number }}</span></h6>
                </div>
                <div class="p-5 grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1">Tanggal Order <span
                                class="text-red-500">*</span></label>
                        <input type="date" name="order_date" value="{{ old('order_date', $purchaseOrder->order_date) }}"
                            required class="{{ $inp }}">
                    </div>
                    <div>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <textarea name="notes" rows="2" class="{{ $inp }}">{{ old('notes', $purchaseOrder->notes) }}</textarea>
                    </div>
                </div>
            </div>
