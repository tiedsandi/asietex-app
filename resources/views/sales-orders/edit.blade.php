            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white py-3">
                        <h6 class="mb-0 fw-semibold">Informasi Sales Order — <span
                                class="text-muted">{{ $salesOrder->so_number }}</span></h6>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="date" name="order_date" class="form-control"
                                    value="{{ old('order_date', $salesOrder->order_date) }}" required>
                            </div>
                            <div class="col-md-3">
                                ...
                                <select name="status" class="form-select" required>
                                    @foreach (['pending', 'shipped', 'cancelled'] as $s)
                                        <option value="{{ $s }}"
                                            {{ old('status', $salesOrder->status) == $s ? 'selected' : '' }}>
                                            {{ ucfirst($s) }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-12">
                                ...
                                <textarea name="notes" class="form-control" rows="2">{{ old('notes', $salesOrder->notes) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
